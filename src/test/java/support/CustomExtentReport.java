...
import static Runner.MyTestRunner.*;

public class CustomExtentReport implements ConcurrentEventListener {
    ...
    private void runStarted(TestRunStarted event) {
        spark = new ExtentSparkReporter(/*System.getProperty("user.dir")+"/target/*/"ExtentReportResults.html");
